...
import (
	...
	anthropicprovider "github.com/r13xr/antenna/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: antenna auth login --provider anthropic")
		}
